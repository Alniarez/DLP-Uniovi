...
public class ASTPrinter extends DefaultVisitor {
	...
	public Object visit(TipoFuncion node, Object param) {
		...
		visit(indent + 1, "parametros", "List<Definicion>",node.getParametros());
		visit(indent + 1, "tipoRetorno", "Tipo",node.getTipoRetorno());
		visit(indent + 1, "defLocales", "List<Definicion>",node.getDefLocales());
	...
	public Object visit(SentenciaWrite node, Object param) {
		...
		printName(indent, "SentenciaWrite", node, false);
